...
const Navbar = () => {
	...
	return (
		<nav className=" top-0 left-0 w-full z-10 fixed bg-white/30 border-gray-200 dark:bg-gray-900 bg-gradient-to-b from-blue-400/20 via-blue-300/20 to-blue-200/20 backdrop-blur-xl">
			<div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
				...
				<div className="flex items-center md:order-2">
					...
					>
						...
						{
							data?.user?.image ? <Image className='rounded-full object-cover' src={data?.user?.image} alt="user avatar" width={30} height={30} /> : <Image className='rounded-full object-cover bg-slate-100' src='/account_circle.svg' alt="user default avatar" width={30} height={30} />
						}
					</button>
